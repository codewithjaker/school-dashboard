...
const mockStudentData = {
  ...
  rollNo: "10234",
  gender: "male",
  email: "arafat.hossain@student.school.edu",
  mobile: "01734567890",
  department: "mathematics",
  parentName: "Md. Kamal Hossain",
  parentNo: "01898765432",
  bGroup: "O+",
  studentId: "STU-2025-00102",
  admissionType: "regular",
  grade: "grade-10",
  section: "A",
  address: "House 12, Road 4, Dhanmondi, Dhaka",
  previousSchool: "Ideal School & College, Dhaka",
  emergencyContactName: "Fatema Begum",
  emergencyContactNumber: "01922334455",
...
export default function EditStudentPage() {
  ...
  const form = useForm<StudentFormValues>({
    ...
    defaultValues: {
      ...
      first: mockStudentData.first,
      last: mockStudentData.last,
      gender: mockStudentData.gender,
      email: mockStudentData.email,
      mobile: mockStudentData.mobile,
      department: mockStudentData.department,
      parentName: mockStudentData.parentName,
      parentNo: mockStudentData.parentNo,
      bGroup: mockStudentData.bGroup,
      studentId: mockStudentData.studentId,
      admissionType: mockStudentData.admissionType,
      grade: mockStudentData.grade,
      section: mockStudentData.section,
      address: mockStudentData.address,
      previousSchool: mockStudentData.previousSchool,
      emergencyContactName: mockStudentData.emergencyContactName,
      emergencyContactNumber: mockStudentData.emergencyContactNumber,
      medicalInfo: mockStudentData.medicalInfo,
      transportMode: mockStudentData.transportMode,
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink>Edit Student</BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
